...
public class CadastrarItemExtraCommandValidator : BaseValidator<CadastrarItemExtraCommand>,
    ICadastrarItemExtraCommandValidator
{
    public CadastrarItemExtraCommandValidator()
    {
        RuleFor(x => x.Nome)
            .NotEmpty()
